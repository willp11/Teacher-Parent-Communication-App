    ...
    let school_class_list = props.profile.teacher.school_classes.map((school_class) => {
        return (
            <Link to={"/class/"+school_class.id}>
                <div key={school_class.id} className="py-3 rounded-lg border border-gray-300 w-64 mx-auto mb-2 bg-sky-100 hover:bg-indigo-500 hover:text-white font-bold shadow-sm">
